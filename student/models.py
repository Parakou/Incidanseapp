...
class Eleve(bd.Model):
    ...
    eleve_mail = bd.Column(bd.String(45),info={'label': 'Adresse mail','validators': [email()]})
    eleve_mail2 = bd.Column(bd.String(45),info={'label': 'Adresse mail 2','validators': [email()]})
